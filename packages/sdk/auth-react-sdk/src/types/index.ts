...
// Component prop types for AuthGuard
export interface AuthGuardComponentProps {
    reason?: string;
}

export interface AuthGuardRedirectingProps {
    destination?: string;
    reason?: string;
    decision: AuthGuardDecision;
}

export interface AuthGuardErrorProps {
    error: string;
    retry?: () => void;
}
