          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>View your account details and type</CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sessions expire after {Math.floor((account.security?.sessionTimeout || 3600) / 60)} minutes of
                      inactivity
                    </p>
                  </div>
                  <Badge variant="outline">{Math.floor((account.security?.sessionTimeout || 3600) / 60)}m</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Export or logout from your account</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Export Data */}
                <div className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="text-sm text-muted-foreground">Manage multiple accounts</div>
                    </div>
                  </Button>
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="text-sm text-muted-foreground">Return to main application</div>
                    </div>
                  </Button>
                </div>
              </CardContent>
