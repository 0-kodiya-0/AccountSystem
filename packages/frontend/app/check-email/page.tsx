        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium text-yellow-800 dark:text-yellow-200">Important Security Notice</p>
              <p className="text-xs text-yellow-700 dark:text-yellow-300">
                The verification link will expire in 24 hours for security reasons. If you don&apos;t verify within this
                time, you&apos;ll need to sign up again.
              </p>
            </div>
          </div>
        </div>
