...
export function AuthLayout({ children, title, description, showBackToHome = false }: AuthLayoutProps) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-primary-100 text-lg mt-4 leading-relaxed">
                Manage your accounts securely with support for multiple authentication methods, two-factor
                authentication, and seamless account switching.
              </p>
            </div>
          ...
          <div className="text-primary-200 text-sm">
            {config.companyName && <>© 2024 {config.companyName}. All rights reserved.</>}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            {description && <p className="text-muted-foreground text-center lg:text-left">{description}</p>}
          </div>
          ...
          <div className="space-y-4">
            {showBackToHome && config.homeUrl && (
              <div className="text-center">
                <Link href={config.homeUrl} className="text-sm text-muted-foreground hover:text-primary">
