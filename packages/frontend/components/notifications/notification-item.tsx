...
import { AlertCircle, CheckCircle, Info, AlertTriangle, ExternalLink, MoreVertical, Eye, Trash2 } from 'lucide-react';
...
export function NotificationItem({ notification, showActions = true, onClick, accountId }: NotificationItemProps) {
  const [isDeleting, setIsDeleting] = useState(false);
  const { markAsRead, deleteNotification } = useNotifications(accountId);
