...
export function NotificationCenter({ accountId }: NotificationCenterProps) {
  ...
  const { notifications, unreadCount, markAllAsRead, deleteAllNotifications } = useNotifications(accountId);
  ...
  const getConnectionState = () => {
    ...
    return connectionInfo.state.charAt(0).toUpperCase() + connectionInfo.state.slice(1);
  };
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm font-semibold">{getConnectionState()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch id="sound-notifications" checked={soundEnabled} onCheckedChange={handleToggleSound} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                {browserNotificationsEnabled ? (
                  ...
                  <Button variant="outline" size="sm" onClick={handleRequestBrowserPermission}>
                    Enable
                  </Button>
                )}
              </div>
