...
const twoFactorTempCache = new LRUCache<string, TwoFactorTempToken>(
  twoFactorTempOptions,
);
const passwordResetCache = new LRUCache<string, PasswordResetToken>(options);
const emailVerificationCache = new LRUCache<string, EmailVerificationToken>(
  verificationOptions,
);
...
export const getTwoFactorTempToken = (
  token: string,
