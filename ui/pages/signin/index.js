      ...
      <SignInAndUpBody>
        <form className='w-full h-full flex justify-center flex-col items-center'>
          ...
          <div className="mb-8 w-10/12">
            <label for="input-group-1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
          ...
          <div className="mb-7 w-10/12">
            <label for="input-group-2" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
            <div className="relative">
